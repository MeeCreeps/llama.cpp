...
methods="${ELASTIC_METHODS:-static-min,static-max,mru,offline,online,diff-tree-mixed}"
artifact_root="${ELASTIC_ARTIFACT_ROOT:-exp-results/Meta-Llama-3-8B-Instruct-Q4_0/difftree_gpu_native_full10min_all_baselines_op13_20260728_graph1_budgetsafe_v3}"
bench_seconds="${ELASTIC_BENCH_SECONDS:-600}"
granularity_profile="${ELASTIC_GRANULARITY_PROFILE:-runtime/plan/profiles/granularity/op13_llama3_8b_q4_gpu_pipeline_20260727.json}"
