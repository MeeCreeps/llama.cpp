...
artifact_root="${ELASTIC_ARTIFACT_ROOT:-exp-results/Meta-Llama-3-8B-Instruct-Q4_0/difftree_cpu_native_full10min_all_baselines_op13_20260728_budgetfair_freqaudit_v2}"
...
granularity_profile="${ELASTIC_GRANULARITY_PROFILE:-runtime/plan/profiles/granularity/op13_llama3_8b_q4_cpu_pipeline_budgetfair_i8mm_20260728.json}"
