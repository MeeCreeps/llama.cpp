...
ELASTIC_ARTIFACT_ROOT="${ELASTIC_ARTIFACT_ROOT:-exp-results/Meta-Llama-3-8B-Instruct-Q4_0/difftree_gpu_native_full10min_outputpin_diff_before_op12_20260729_v21}" \
ELASTIC_METHODS=diff-tree-mixed \
ELASTIC_GRANULARITY_PROFILE="${ELASTIC_GRANULARITY_PROFILE:-runtime/plan/profiles/granularity/op12_llama3_8b_q4_gpu_pipeline_mixedboundary_outputpin_phase_only_20260729_v21.json}" \
